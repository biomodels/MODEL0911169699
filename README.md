...
`pip install git+https://github.com/biomodels/MODEL0911169699.git`

To install a specific version (in this example, from the 2014-09-16 BioModels release)

`pip install git+https://github.com/biomodels/MODEL0911169699.git@20140916`

## Usage

Importing the model package.

`import MODEL0911169699 as model`
...
version02** ](http://www.cellml.org/models/guyton_non_muscle_blood_flow_contro
l_2008_version02)  
